export const skills: any = {
  nextjs: { imgSrc:"imgs/icon/nextjs.png",skillName:"Nextjs" },
  ...
  mui: { imgSrc:"imgs/icon/mui.png",skillName:"MUI" },
  reduxSaga: { imgSrc:"imgs/icon/redux-saga.png",skillName:"Redux-Saga" },
  github: { imgSrc:"imgs/icon/github.png",skillName:"Github" },
  redux: { imgSrc:"imgs/icon/redux.png",skillName:"Redux" },
  jquery: { imgSrc:"imgs/icon/antd.png",skillName:"jquery" },
  sass: { imgSrc:"imgs/icon/sass.png",skillName:"Sass" },
  expressjs: { imgSrc:"imgs/icon/expressjs.png",skillName:"express.js" },
  nodejs: { imgSrc:"imgs/icon/nodejs.png",skillName:"Node.js" },
  antd: { imgSrc:"imgs/icon/antd.png",skillName:"Ant Design" },
  'c#': { imgSrc:"imgs/icon/antd.png",skillName:"c#" },
  mssql: { imgSrc:"imgs/icon/antd.png",skillName:"mssql" },
  tailwindCss: { imgSrc:"imgs/icon/antd.png",skillName:"tailwindCss" },
}
